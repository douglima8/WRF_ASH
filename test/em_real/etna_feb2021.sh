...
DIR_EMISSION=/cantiere/rizza/WRFCHEM/prepare_emissions/etna_feb_2021
CASE=etna-T
...
cd /cantiere/rizza/WRFCHEM/prepare_emissions/VOLCANIC/ESP_2021
ncl esp.ncl
cp etna_2021_wrfchem.dat etna_wrfchem.dat
