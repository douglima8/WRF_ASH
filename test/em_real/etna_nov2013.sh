...
DIR_EMISSION=/cantiere/rizza/WRFCHEM/prepare_emissions/etna_nov_2013
CASE=etna-T
...
ln -sf $DIR_EMISSION/$CASE-$year-$cmes-$cday-000000-g1-volc.bin volc_d01
...
ln -sf volc_d01 wrfchemv_d01_$year-$cmes-${cday}_$ihr:00:00
...
#################### -------------------------------------------------------
rm -f etna_wrfchem.dat
cd /cantiere/rizza/WRFCHEM/prepare_emissions/VOLCANIC/ESP_2013_nov 
ncl esp_voldorad.ncl 
cp etna_2013_wrfchem.dat etna_wrfchem.dat
cp etna_wrfchem.dat $W361
cd $W361
#################### -------------------------------------------------------
